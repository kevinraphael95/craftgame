...
const ELEMENTS = {
  ...
  // Antiparticules
  "Antiquark Up":    { emoji:"🔴", cat:"quark",    label:"Antiquark ↑",   desc:"Antimatière du quark up. Charge −2/3.", anti:"Quark Up" },
  "Antiquark Down":  { emoji:"🔵", cat:"quark",    label:"Antiquark ↓",   desc:"Antimatière du quark down. Charge +1/3.", anti:"Quark Down" },
  "Positron":        { emoji:"⚡", cat:"lepton",   label:"Positron e⁺",   desc:"Antimatière de l'électron. Charge +1.", anti:"Électron" },
  "Antiproton":      { emoji:"🔴", cat:"hadron",   label:"Antiproton",    desc:"ūūd̄. Antimatière du proton.", anti:"Proton" },
  // Hadrons
...
// Paires antimatière → annihilation
const ANTIMATTER_PAIRS = {
  "Antiquark Up":   "Quark Up",
  "Antiquark Down": "Quark Down",
  "Positron":       "Électron",
  "Antiproton":     "Proton",
};
...
const RECIPES_2 = [
  // Antimatière
  { a:"Quark Up",    b:"Quark Down",    r:"Antiquark Up",       eq:"u + d → ū",                    info:"Interaction par échange de gluons. Antiquark up créé." },
  { a:"Quark Up",    b:"Quark Strange", r:"Antiquark Down",     eq:"u + s → d̄",                   info:"Antiquark down via interaction faible." },
  { a:"Photon",      b:"Électron",      r:"Positron",           eq:"γ → e⁻ + e⁺ (pair prod.)",    info:"Création de paires à haute énergie. E > 1.022 MeV." },
  { a:"Proton",      b:"Gluon",         r:"Antiproton",         eq:"pp̄ via accélérateur",          info:"CERN 1955. Chamberlain & Segrè, Nobel 1959." },
  // Quarks → hadrons
